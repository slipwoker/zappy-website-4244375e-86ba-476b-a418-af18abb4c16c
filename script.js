document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function setFieldError(field, message) {
      ...
      field.classList.remove('field--success', 'success');
    ...
    function setFieldSuccess(field) {
      ...
      field.classList.add('field--success', 'success');
    ...
    function clearFieldState(field) {
      field.classList.remove('field--error', 'error', 'field--success', 'success');
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < minLen) {
          setFieldError(field, field.dataset.errorMinlength || 'Input is too short (minimum ' + minLen + ' characters).');
          return false;
        }
      }
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > maxLen) {
          setFieldError(field, field.dataset.errorMaxlength || 'Input is too long (maximum ' + maxLen + ' characters).');
          return false;
        }
      }
      ...
      const scrollObserver = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            if (delayMs > 0) {
              setTimeout(function () {
                el.classList.add(ANIMATION_CLASS, 'visible', 'animated');
              }, delayMs);
            } else {
              el.classList.add(ANIMATION_CLASS, 'visible', 'animated');
            }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מרכז טיפול רגשי - NLP משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4244375e-86ba-476b-a418-af18abb4c16c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4244375e-86ba-476b-a418-af18abb4c16c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4244375e-86ba-476b-a418-af18abb4c16c';
